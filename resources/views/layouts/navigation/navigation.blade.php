<nav class="navbar d-flex sticky navbar-expand navbar-light bg-white topbar static-top shadow ", style="height: 90px;">
    ...
    <div class="first-header d-flex align-items-center">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- Counter - Alerts -->
                <span class="mr-2 d-none d-lg-inline text-dark small">Language</span>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item" href="#">
                    <i class="fa fa-globe-americas fa-sm fa-fw mr-2 text-gray-400"></i>
                    English
                </a>
                <a class="dropdown-item" href="#">
                    <i class="fa fa-globe-asia fa-sm fa-fw mr-2 text-gray-400"></i>
                    Khmer
                </a>
            </div>
        </li>
