                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{-- <input type="text" class="form-control text-start"
                                            ...
                                            value="{{ old('usage_unit_water', ($water->location_number_water ?? '') . ' | ' . ($water->usage_unit_water ?? '')) }}"
                                        ...
                                        <input type="text" class="form-control text-start"
                                            placeholder="ស្វែងរកអង្គភាពប្រើប្រាស់..." id="searchInput"
                                            value="{{ old('usage_unit_water', ($water->location_number_water ?? '') . ' | ' . ($water->usage_unit_water ?? '')) }}"
                                            style="height: 40px; width: 100%;" readonly>
                                        ...
                                        <select name="usage_unit_water" id="usageUnitWaterSelect" class="form-control"
                                            ...
                                            @foreach ($titleUsageUnitsWater as $titleUsageUnitWater)
                                                <option value="{{ $titleUsageUnitWater->title_usage_unit_water }}"
                                                    data-full-text="{{ $titleUsageUnitWater->location_number_water }} | {{ $titleUsageUnitWater->title_usage_unit_water }}"
                                                    {{ old('usage_unit_water', $water->usage_unit_water) == $titleUsageUnitWater->title_usage_unit_water ? 'selected' : '' }}>
                                                    {{ $titleUsageUnitWater->location_number_water }} |
                                                    {{ $titleUsageUnitWater->title_usage_unit_water }}
                                                </option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="usage_start" id="usage_start"
                                                    value="{{ $water->usage_start }}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="usage_end" id="usage_end"
                                                    value="{{ $water->usage_end }}" class="form-control"
                                                    style="height: 40px; width: 100%;">
                                                @error('usage_end')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="usage_date" id="usage_date"
                                                    value="{{ $water->usage_date }}" class="form-control"
                                                    style="height: 40px; width: 100%;">
                                                @error('usage_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="kilowatt_water" id="kilowatt_water"
                                                    value="{{ $water->kilowatt_water }}" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_number" id="invoice_number"
                                                    value="{{ $water->invoice_number }}" class="form-control"
                                                    style="height: 40px; width: 100%;" min="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="total_cost" id="total_cost"
                                                    value="{{ $water->total_cost }}" class="form-control"
                                                    style="height: 40px; width: 100%;" min="0">
                                                @error('total_cost')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
