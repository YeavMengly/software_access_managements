        ...
        <div class="result-total-table-container">
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <a class="btn btn-danger" href="{{ route('mandates.index') }}"
            ...
            <div class="d-flex justify-content-center align-items-center  ">
                <div class="card shadow-lg w-65" style="max-width: 900px;">
                    <h3 class="card-title text-center mt-4" style="font-weight: 500;">កែអាណត្តិ</h3>
                    <div class="card-body px-5 py-4">
                        <form action="{{ route('mandates.update', $mandate->id) }}" method="POST"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4 d-flex flex-column align-items-center">
                                    <div class="form-group">
                                        ...
                                        <select name="report_key" id="reportKeySelect" class="form-control" size="5"
                                            onchange="updateReportInputField()" style="width: 230px; height: 120px;">
                                            @foreach ($sortedReports as $dataMandate)
                                                <option value="{{ $dataMandate->id }}"
                                                    {{ $mandate->report_key == $dataMandate->id ? 'selected' : '' }}>
                                            ...
                                            @foreach ($missionTypes as $missionType)
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="mission_type"
                                                        ...
                                                        {{ $mandate->mission_type == $missionType->id ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 d-flex flex-column align-items-start">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ul id="fileList" style="padding-left: 24px;">
                                            @if ($mandate->attachments)
                                                @foreach (json_decode($mandate->attachments) as $file)
                                                    <li>
