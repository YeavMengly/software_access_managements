                ...
                <div class="d-flex justify-content-center align-items-center">
                    <div class="card shadow-lg" style="width: 90%;"> <!-- Adjusted width to 1080px -->
                        ...
                        <h3 class="card-title text-center mt-4" style="font-weight: 500;">កែទិន្នន័យឥណទានអនុម័តដើមឆ្នាំ
                            សម្រាប់អាណត្តិរ</h3> <!-- Moved h3 out of the card-body -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <p id="resultCount" style="font-weight: bold; margin-top: 8px;">ចំនួន: 0
                                                    </p>

                                                    <select name="sub_account_key" id="subAccountKeySelect"
                                                        class="form-control" size="5" onclick="getSelectedValue()"
