                ...
                <div class="col-lg-12 margin-tb mb-4">
                    <div class="col-lg-12 margin-tb mb-4">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-success" href="{{ route('codes.create') }}">
                        ...
                        <form class="max-w-md mx-auto mt-3" method="GET" action="">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="sub_account_key_id"
                                        value="{{ request('sub_account_key_id') }}" class="form-control mb-2"
                                        placeholder="លេខអនុគណនី">
                                </div>
                                <div class="col-md-3">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @forelse ($reports as $report)
                        <tr>
                            <td style="border: 1px solid black; max-width: 20px; text-align: center">{{ $loop->iteration }}
                            </td>
