            ...
            <div class="row">
                <div class="col-lg-12 margin-tb mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <h3 class="mx-auto" style="font-weight: 500;">តារាងលេខជំពូក</h3>

                        <a class="btn btn-primary d-flex justify-content-center align-items-center"
                            href="{{ route('keys.create') }}" style="width: 120px; height: 40px; border-radius: 4px;">
                            បញ្ចូល
                        </a>
                    ...
                    {{-- Field Search --}}
                    <form class="max-w-md mx-auto mt-2" method="GET" action="{{ route('keys.index') }}">
                        <div class="row">
                            <div class="col-md-6">
