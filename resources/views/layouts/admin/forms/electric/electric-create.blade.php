                        ...
                        <form action="{{ route('electrics.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="searchSubAccountKey" class="font-weight-bold text-center">
                                            <strong>អង្គភាពប្រើប្រាស់:</strong>
                                        </label>
                                        <input type="text" class="form-control text-center"
                                            placeholder="ស្វែងរកលេខអនុគណនី..." style="width: 230px; height: 40px;"
                                            id="searchInput" oninput="filterOptions()" title="Hover for more info">
                                        <p id="resultCount" style="font-weight: bold; margin-top: 8px;">ចំនួន: 0</p>

                                        <select name="usage_unit" id="subAccountKeySelect" class="form-control"
                                            size="5"
                                            style="height: 130px; width: 230px; overflow-x: auto; white-space: nowrap;"
                                            onclick="getSelectedValue()">
                                            @foreach ($titleUsageUnits as $titleUsageUnit)
                                                <option value="{{ $titleUsageUnit->title_usage_unit }}"
                                                    title="{{ $titleUsageUnit->location_number }} >  {{ $titleUsageUnit->title_usage_unit }}">{{ $titleUsageUnit->location_number }} > {{ $titleUsageUnit->title_usage_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="fin_law"
                                            class="font-weight-bold text-center"><strong>កាលបរិច្ឆេទ:</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label for="total_amount"
                                            class="font-weight-bold text-center"><strong>ប្រាក់សរុបជារៀល:</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label for="current_loan"
                                            class="font-weight-bold text-center"><strong>រយៈពេលចាប់ផ្ដើមប្រើប្រាស់:</strong></label>
                                        <input type="date" name="usage_start" id="usage_start"
                                            class="form-control @error('usage_start') is-invalid @enderror"
                                            style="width:  230px;  height: 40px;" min="0">
                                        @error('usage_start')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="current_loan"
                                            class="font-weight-bold text-center"><strong>រយៈពេលបញ្ចប់ប្រើប្រាស់:</strong></label>
                                        <input type="date" name="usage_end" id="usage_end"
                                            class="form-control @error('usage_end') is-invalid @enderror"
                                            style="width:  230px;  height: 40px;" min="0">
                                        @error('usage_end')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="current_loan"
                                            class="font-weight-bold text-center"><strong>ថាមពលគីឡូវ៉ាត់:</strong></label>
                                        <input type="number" name="kilowatt_energy" id="kilowatt_energy"
                                            class="form-control @error('kilowatt_energy') is-invalid @enderror"
                                            style="width:  230px;  height: 40px;" min="0">
                                    ...
                                    <div class="form-group">
                                        <label for="current_loan"
                                            class="font-weight-bold text-center"><strong>ថាមពលរ៉េអាក់ទិក:</strong></label>
                                        <input type="number" name="reactive_energy" id="reactive_energy"
                                            class="form-control @error('reactive_energy') is-invalid @enderror"
                                            style="width:  230px;  height: 40px;" min="0">
